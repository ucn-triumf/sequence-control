...
CFLAGS   =  -g -O2 -Wall -Wuninitialized -I$(INC_DIR) -I$(DRV_DIR) -I$(VMICHOME)/include -fpermissive -fPIE
CXXFLAGS = $(CFLAGS) -DHAVE_ROOT -DUSE_ROOT -I$(ROOTSYS)/include -fpermissive -fPIC

LIBS = -lm -lz -lutil -lnsl -lpthread -lrt -L/home/lindner/packages/vmisft-7433-3.6-KO5/vme_universe  -fPIE

MIDASSYS = /home/ucn/packages/midas_ubuntu22

DRV_DIR         = $(MIDASSYS)/drivers
INC_DIR         = $(MIDASSYS)/include
#LIB_DIR         = $(MIDASSYS)/linux-m32/lib
LIB_DIR         = $(MIDASSYS)/lib
#/home/ucn/packages/midas/linux-m32/lib/
...
gefvme.o: $(MIDASSYS)/drivers/vme/vmic/gefvme.c
	g++ -c -o $@ -O2 -fPIE -g -Wall -Wuninitialized $< -I$(MIDASSYS)/include
...
#sequence_control_multi_valve.exe: $(MIDASLIBS) $(LIB_DIR)/mfe.o sequence_control_multi_valve.o vmicvme.o 
#	$(CXX) -o $@ $(CFLAGS) $(OSFLAGS) $^ $(MIDASLIBS) $(LIBS) -lvme
